...
def get_args():
    ...
    parser.add_argument('--out-datasets', default=[ 'SVHN', 'LSUN_resize', 'Imagenet_resize', 'iSUN', 'texture'], nargs="*", type=str,
    ...
    parser.add_argument('--method', default='palm',
    ...
    parser.add_argument('--save-path', default="ADAPT_FIN.pt",
    ...
    parser.add_argument('--proto_m', default=0.5, type=float, help="prototypes update momentum")
